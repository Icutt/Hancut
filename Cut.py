...
console = Console()
sys.stdout.write('\x1b]2; Icutt | Ayons Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
pretty.install()
CON=sol()
ugen2=[]
...
try:
	...
	print(' ╰─  Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari Ayons')
...
for xd in range(10000):
	...
	uaku=f'Mozilla/5.0 (Linux; Android 12; CPH2269) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Mobile Safari/537.36'
	ugen2.append(uaku)
...
for t in range(10000):
	...
	d=random.randrange(4200,4900)
	e=random.randrange(40,150)
	Icutt=f'Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3653 Build/IXW70V) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/38.0.6148.80 Mobile Safari/537.36 HeyTapBrowser/10.7.36.1'
	Icutt2=f'Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3648 Build/DVP79E) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/59.0.5025.80 Mobile Safari/537.36 HeyTapBrowser/11.7.36.1'
	Icutt3=f'Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3657 Build/ZDT57D) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.9174.80 Mobile Safari/537.36 HeyTapBrowser/29.7.36.1'
	Icutt4=f'Mozilla/5.0 (Linux; U; Android 18; zh-CN; MZ-meizu 17 Bui ld/MRA58K) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/62.7.6 787.(756 MZBrowser/9.14.1 Mobile Safari/537.3657 Build/ACG67Y) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.3471.80 Mobile Safari/537.36 HeyTapBrowser/31.7.36.1'
	uaku2 = random.choice([icutt,Icutt2,icutt3,icutt4])
	ugen.append(uaku2)

for x in range(10):
	a='Mozilla/5.0 (Linux; Android 12; SM-G970F Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, seperti Geck) Versi/4.0 Chrome/'
...
def banner():
 ...
 | |_ / /_\ \ /  \/| |__ | |_/ /| | | || | | | |/ /     |  |   Source Code Ayons
 |  _||  _  | |    |  __|| ___ \| | | || | | |    \     |  |   Update By Icuttyns 
...
def menu(my_name,my_id):
	...
	cetak(panel(f'[bold white] Thanks To Ayons, Icuttyns 😁 😁',width=90,style=f"bold white"))
	...
	_____Icuttt___yns____ = input(f' ╰─  Pilih Menu Crack : ')
	if _____Icuttt___yns____ in ['1','01']:
		brayen_dump()
	elif _____Icuttt___yns____ in ['2','02']:
		dump_massal()
	elif _____Icuttt___yns____ in ['3','03']:
		result()
	elif _____Icuttt___yns____ in ['lainnya','Lainnya','LAINNYA']:
		lainnya()
	elif _____Icuttt___yns____ in ['Bot','BOT','bot']:
		bot()
	elif _____Icuttt___yns____ in ['0','00']:
...
def bot():
	...
	if yons in('1','01'):
		...
		os.system("xdg-open https://wa.me/+6285762949202?text=Selamat+Pagi+Bang+Saya+Mau+Melaporkan+Bug+Pada+Sc+Mu+Bang")
		time.sleep(3)
		exit()
...
agent = random.choice(
		[
			"Mozilla/5.0 (Linux; Android 10; POCOPHONE F1 Build/QKQ1.190828.002; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36 Flipboard/4.3.2/5322,4.3. 2.5322",
			"Mozilla/5.0 (Linux; U; Android 6.0.1; zh-cn; OPPO R9st Build/MMB29M) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/90.0.4430.61 Mobile Safari/537.36 HeyTapBrowser/10.8.5.2",
			...
			"Mozilla/5.0 (Linux; Android 7.1.2; GT-I9500 Build/NJH47F) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/75.0.3770.101 Mobile Safari/537.36 Maxthon/9000",
			"Mozilla/5.0 (Linux; Android 11; CPH2269 Build/RP1A.200720.011) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 Maxthon/12100","Mozilla/5.0 (Linux; Android 11; Infinix X662 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36[FBAN/EMA;FBLC/fr_FR;FBAV /333.0.0.12.108;]",
			"Mozilla/5.0 (Linux; U; Android 11; de-de; POCO M3 Pro 5G Build/RP1A.200720.011) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/89.0.4389.116 Seluler Safari/537.36 XiaoMi/MiuiBrowser/ 12.13. -gn", 
			"Mozilla/5.0 (Linux; Android 8.1.0; vivo 1820 Build/O11019; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/8.3.1.0", 
	]
)
